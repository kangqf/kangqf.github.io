require([], function (){
	...
	if(yiliaConfig.animate === true){
        ...
        require([
          ...
          var animationNames = [
			 "lightSpeedIn","bounce","pulse","rubberBand","shake","swing","bounceInDown","bounceInLeft","bounceInRight", "bounceInUp", "zoomInLeft", "zoomInRight", 
	...
	//随机颜色
 	...
 	//PC
 	$("#container .left-col .overlay").css({"background-color": colorList[id],"opacity": 1.0});
 	//移动端
